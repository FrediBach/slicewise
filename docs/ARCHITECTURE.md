...
- `projection.ts` owns deterministic camera bases, perspective blending, Klein↔Poincaré and optical lens warps, mesh projection, and arbitrary world-point projection. Mesh contours and imported SVG centrelines use the same pure projection path.

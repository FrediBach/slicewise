...
- `gcode-calibration.ts` creates the deterministic 120×90 mm UUNA contact ladder, angle-offset crosses, and taper fan as ordinary 3D machine operations so calibration files share the production serializer and validator.

...
- `gcode-3d-toolpaths.ts` defines the DOM-free machine-point and operation model for opt-in coordinated XYZ plotting. Its Phase 1 builder converts already clipped and travel-ordered UUNA runs into constant-contact operations; pressure shaping and angled-tip compensation extend this boundary rather than the serializer.

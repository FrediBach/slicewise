...
- `map-features.ts` creates seeded cartographic building clusters, six landmark symbols, woodland, roads, rivers, and lakes inside the convex footprint of finished contours. It returns ordinary polylines, feature-name anchors, and contour-clearance masks. Routes are decorative; they do not infer drainage from a projected view.

...
describe('OutputPanel composition boundaries', () => {
  ...
  it('preserves the canvas and export controls through the panel barrel', () => {
    ...
    expect(document.getElementById('uunaSurfaceYOffsetN')).toHaveValue(0);
    expect(document.getElementById('uunaSurfaceCompensationControls')).toHaveAttribute('hidden');
    expect(document.getElementById('uunaSurfaceCalibrationDownload')).toHaveTextContent(

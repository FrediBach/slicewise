...
const hardeningSettings = {
  ...
  objectBulgeAmount: 20,
  objectBulgeCenter: 40,
  objectShearAmount: 15,
  objectShearDirection: 35,
  objectTwistAngle: 25,
  objectBendAngle: 15,
  objectRotationX: 10,
  objectRippleAmount: 3,
  objectNoiseAmount: 2,
  az: -28,
  el: 38,
  roll: 17,
  ...
  wraparoundTearPosition: 58,
  wraparoundTearSize: 16,
  wraparoundTearShift: -11,
  tileShuffle: true,
  tileShuffleRows: 2,
  tileShuffleColumns: 2,
  ...
  misregistrationOffset: 1.2,
  misregistrationRotation: 0.3,
...
const meshCases: ReadonlyArray<readonly [string, Partial<ContourSettings>]> = [
  ...
  [
    ...
    { projectionWarpMode: 'stereographic', sphericalStrength: 72, misregistration: true },
  ],
